...
from routers.post_routers.assignment import assignment_router
...
from routers.get_routers.assignments import router
...
@app.include_router(assingment_comment_router, tags=["Comment on Student Assignment"])
@app.include_router(router, prefix="/assignments", tags=["Get All Submitted Assignments"])